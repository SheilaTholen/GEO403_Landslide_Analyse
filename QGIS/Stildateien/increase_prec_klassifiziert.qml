...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.6-Białowieża" styleCategories="AllStyleCategories" minScale="1e+08" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" alphaBand="-1" type="paletted" opacity="1">
      ...
      <colorPalette>
        <paletteEntry value="1" alpha="255" label="&lt; 5" color="#e4fff4"/>
        <paletteEntry value="2" alpha="255" label="5 -10" color="#acdad4"/>
        <paletteEntry value="3" alpha="255" label="10 - 15" color="#74b4b4"/>
        <paletteEntry value="4" alpha="255" label="15 - 20" color="#3c8f94"/>
        <paletteEntry value="5" alpha="255" label="> 20" color="#046974"/>
      </colorPalette>
