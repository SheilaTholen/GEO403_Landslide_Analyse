...
<qgis maxScale="0" version="3.22.6-Białowieża" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" type="paletted" alphaBand="-1" nodataColor="" band="1">
      ...
      <colorPalette>
        <paletteEntry label="Vulkanite &amp; Dikes" value="1" color="#ffa805" alpha="255"/>
        <paletteEntry label="Sedimentgestein" value="2" color="#53a9a9" alpha="255"/>
        <paletteEntry label="Metamorphite" value="3" color="#dfc9bd" alpha="255"/>
        <paletteEntry label="Intrusivgestein" value="4" color="#ea4e39" alpha="255"/>
        <paletteEntry label="Lockergestein" value="5" color="#7cb26a" alpha="255"/>
        <paletteEntry label="Sonstiges" value="6" color="#b8c5c7" alpha="255"/>
      </colorPalette>
